...
Resources/                catalog.json (1,684 verified services)
...
1,684 verified services across 22 categories. Entries have working endpoints: `/api/v2/summary.json` for `statuspage`, the feed URL for `rss`, `/index.json` for `betterstack`.
